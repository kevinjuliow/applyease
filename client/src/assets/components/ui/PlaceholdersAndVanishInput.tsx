  ...
  return (
    ...
    >
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative text-sm sm:text-base z-50 border border-black bg-transparent text-black h-full rounded-full focus:outline-none focus:ring-0 pl-4 sm:pl-10 pr-20",
      ...
      <button
        disabled={!value}
        type="submit"
        className="absolute right-2 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full disabled:bg-gray-500 bg-black transition duration-200 flex items-center justify-center cursor-pointer"
      >
        <motion.svg
