  ...
  return (
    ...
    <div className="flex justify-center items-center">
      <div className="flex justify-center items-center">
        ...
        <a href="/register/applicant" className="rounded-md custom-hover-box ms-4 border border-purple-500 w-60 h-48 flex flex-col items-center justify-center hover:bg-purple-100">
          {applicantIcon}
