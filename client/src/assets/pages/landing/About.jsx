...
const About = () => {
  return (
    <>
    <div className="h-auto flex flex-col items-center justify-center fixed bottom-0 mb-5 bg-transparent">
      <div className="flex justify-between items-start md:h-auto h-[180px]">
        <div className="flex flex-col items-center justify-center w-[80px] md:w-[140px] md:mt-0 mt-20 md:mx-6 mx-0 hover:-translate-y-4 ease-in-out duration-300 md:static relative left-6">
    ...
    <div className="fixed bg-purple-100 bottom-0 w-[90%] h-[160px] z-[-99] rounded-t-full shadow-2xl"></div>
    </>
  )
}
