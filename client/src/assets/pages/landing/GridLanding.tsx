...
import companyImage from "../../images/companyKnowYou.jpg"
...
export function GridLanding() {
  const features = [
    {
      title: "Track Applied Job",
      description:
        "Track your Applied Job Real-time",
    ...
    },
    {
      ...
      description:
        "Upload your Resume to let them know more about you",
      skeleton: <SkeletonTwo />,
      className: "border-b col-span-1 lg:col-span-2 dark:border-neutral-800",
    },
    {
      title: "Let Big Companies to know You",
      description:
        "There's a lot of Company that are looking for Worker . Let them know You",
    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          From Apply a Job , Upload CV , and many more
        </p>
      </div>
